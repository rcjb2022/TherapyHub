...
// Client component for Patient Information Form
// Contains all interactive logic, state management, and form UI
...
export default function PatientInformationForm({ patientId }: PatientInformationFormProps) {
          ...
          if (existingForm) {
            ...
            if (existingForm.formData) {
              setFormData({
                ...
                idFront: existingForm.formData.idFront || '',
                idBack: existingForm.formData.idBack || '',
              })
            }
          } else {
        ...
        <div className="mb-8">
          ...
          <div className="rounded-lg bg-blue-50 border border-blue-200 p-4 mb-6">
            <p className="text-sm text-blue-800 font-medium">
              📋 Please upload a government-issued photo ID (Driver's License, State ID, or Passport)
            </p>
          </div>
          ...
          {formData.idType === 'drivers-license' && (
            <>
              <div className="mb-6">
                <FileUpload
                  label="Driver's License / State ID - Front"
                  name="idFront"
                  required
                  patientId={patientId}
              ...
              <div className="mb-6">
                <FileUpload
                  label="Driver's License / State ID - Back"
                  name="idBack"
                  required
                  patientId={patientId}
                  fileType="id-document"
          ...
          {formData.idType === 'passport' && (
            <div className="mb-6">
              <FileUpload
                ...
                currentFileUrl={formData.idFront}
                onUploadComplete={(url) => setFormData({ ...formData, idFront: url })}
                helpText="Upload a clear photo of your passport information page"
              />
            </div>
          )}
        </div>
